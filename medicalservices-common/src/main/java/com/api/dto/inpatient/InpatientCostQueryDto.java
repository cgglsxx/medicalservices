 ...
 * 住院费用清单查询参数对象
 */
@ApiModel(value="住院费用清单查询参数对象",description="住院费用清单查询参数对象")
public class InpatientCostQueryDto extends ParentDto {
    //账号id
    ...
    //开始日期
    @ApiModelProperty(name="startingDate",value="开始日期(yyyy-MM-dd)",example="2018-08-23")
    private String startingDate;
    //结束日期
    @ApiModelProperty(name="closingDate",value="结束日期(yyyy-MM-dd)",example="2018-08-23")
